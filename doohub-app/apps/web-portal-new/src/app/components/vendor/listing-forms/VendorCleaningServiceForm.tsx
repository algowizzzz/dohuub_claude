...
export function VendorCleaningServiceForm({
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    whatsIncluded: [
      {
        id: "1",
        text: "Professional equipment & supplies",
        checked: initialData?.whatsIncluded?.includes(
      ...
      },
      {
        ...
        checked:
          initialData?.whatsIncluded?.includes("Trained professionals") ||
          false,
      },
      {
        id: "3",
        text: "Eco-friendly products available",
        checked:
      ...
      },
      {
        ...
        checked:
          initialData?.whatsIncluded?.includes("Quality guarantee") || false,
      },
    ],
    customIncludedItems: [],
  });
    ...
    <div className="max-w-[900px] mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm sm:text-[15px] text-[#6B7280]">
          {isEditing
            ? "Update your cleaning service listing details"
