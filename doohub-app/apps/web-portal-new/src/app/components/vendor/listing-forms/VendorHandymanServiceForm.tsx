...
export function VendorHandymanServiceForm({
    ...
    whatsIncluded: [
      {
        ...
        checked:
          initialData?.whatsIncluded?.includes("Tools & equipment provided") ||
          false,
      },
      {
        id: "2",
        text: "Skilled handyman professional",
        checked:
          initialData?.whatsIncluded?.includes(
            "Skilled handyman professional"
          ) || false,
      },
      {
        id: "3",
        text: "Quality workmanship guarantee",
        checked:
          initialData?.whatsIncluded?.includes(
      ...
      {
        id: "4",
        text: "Clean-up after service",
        checked:
          initialData?.whatsIncluded?.includes("Clean-up after service") ||
          false,
      },
      {
        id: "5",
        text: "Parts & materials sourcing",
        checked:
          initialData?.whatsIncluded?.includes("Parts & materials sourcing") ||
          false,
      },
    ],
    customIncludedItems: [],
  ...
  const handleSave = async (isDraft: boolean) => {
    ...
    const allIncludedItems = [
      ...formData.whatsIncluded.filter((item) => item.checked).map((item) => item.text),
    ...
    <div className="max-w-[900px] mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm sm:text-[15px] text-[#6B7280]">
          {isEditing
            ? "Update your handyman service listing details"
            : "Add a new handyman service to your store"}
        </p>
      </div>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 sm:p-8 mb-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="border-2 border-dashed border-[#E5E7EB] rounded-xl p-8 text-center hover:border-[#9CA3AF] transition-colors">
              ...
              <p className="text-xs text-[#6B7280] mt-2">
                {formData.thumbnailImage ? "Image uploaded" : "No image selected"}
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-[#6B7280] mb-2">Maximum 500 characters</p>
            <Textarea
              id="longDescription"
              value={formData.longDescription}
              onChange={(e) =>
                handleInputChange("longDescription", e.target.value.slice(0, 500))
              }
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 sm:p-8 mb-6">
        ...
        <div className="space-y-6">
          {/* Pricing Type */}
          <div>
            <Label htmlFor="pricingType" className="mb-1.5">
              Pricing Type <span className="text-[#DC2626]">*</span>
            </Label>
            <p className="text-xs text-[#6B7280] mb-2">
              Defaults to "Hourly Rate"
            </p>
            <Select
      ...
      {/* What's Included */}
      <div className="bg-white border border-[#E5E7EB] rounded-2xl p-6 sm:p-8 mb-6">
        <h2 className="text-xl font-bold text-[#1F2937] mb-6">What's Included</h2>
