...
export default function ListingsPage() {
  ...
  return (
    <PortalLayout title="My Services" subtitle="Manage your business identities across all service categories">
                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2">
                      <Link
                        href={`/vendor/services/${listing.id}/edit?category=${listing.category}`}
                        className="flex-1"
                      >
