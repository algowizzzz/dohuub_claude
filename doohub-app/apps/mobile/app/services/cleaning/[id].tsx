...
const MOCK_PROVIDER = {
  ...
  description: 'Professional deep cleaning services for residential and commercial spaces. Our trained cleaners use eco-friendly products and follow strict quality protocols.',
  rating: 4.9,
  reviewCount: 234,
  isPoweredByDoHuub: true,
  services: [
    { id: '1', name: 'Deep Cleaning', price: 150, duration: '3-4 hours' },
    { id: '2', name: 'Regular Cleaning', price: 100, duration: '2-3 hours' },
    { id: '3', name: 'Move-in/Move-out', price: 200, duration: '4-5 hours' },
  ],
...
export default function ProviderDetailScreen() {
  ...
  const handleBookNow = () => {
    router.push(`/services/cleaning/${id}/book`);
  };
  ...
  const handleViewReviews = () => {
    router.push(`/services/cleaning/${id}/reviews`);
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroImage}>
          <Ionicons name="sparkles" size={64} color={colors.gray[400]} />
        </View>
