...
const MOCK_REVIEWS = [
  {
    ...
    rating: 5,
    date: 'Jan 10, 2026',
    comment: 'Excellent cleaning service! They were thorough and professional.',
  },
  {
    id: '2',
    authorName: 'John D.',
    rating: 5,
    date: 'Jan 8, 2026',
    comment: 'Very impressed with the attention to detail.',
  },
  {
    id: '3',
    authorName: 'Emily R.',
    rating: 4,
    date: 'Jan 5, 2026',
    comment: 'Great service, arrived on time and did a fantastic job.',
  },
];

/**
 * Cleaning Service Reviews Screen
 */
export default function CleaningReviewsScreen() {
