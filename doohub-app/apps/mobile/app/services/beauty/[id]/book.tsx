...
const SERVICES = [
  ...
  { id: '3', name: 'Manicure', price: 35 },
  { id: '4', name: 'Facial Treatment', price: 80 },
];
...
export default function BookingScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScreenHeader title="Book Beauty Service" showBack />
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="E.g., Preferred hair color, any allergies..."
        ...
        <View style={styles.priceSummary}>
          ...
          <View style={[styles.priceRow, styles.totalRow]}>
            ...
            <Text style={styles.totalValue}>${selectedService.price + 5}</Text>
          </View>
        </View>
      </ScrollView>
