...
const MOCK_REVIEWS = [
  {
    ...
    rating: 5,
    date: 'Jan 10, 2026',
    comment: 'Fast delivery and fresh products. Will order again!',
  },
  {
    id: '2',
    ...
    rating: 4,
    date: 'Jan 8, 2026',
    comment: 'Good selection and reasonable prices.',
  },
  {
    id: '3',
    authorName: 'Mark T.',
    rating: 5,
    date: 'Jan 5, 2026',
    comment: 'Excellent service, everything was perfectly packed.',
  },
];

/**
 * Groceries/Store Reviews Screen
 */
export default function GroceriesReviewsScreen() {
