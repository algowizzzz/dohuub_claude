...
const SERVICES = [
  { id: '1', name: 'Plumbing Repair', price: 80 },
  { id: '2', name: 'Electrical Work', price: 100 },
  { id: '3', name: 'Furniture Assembly', price: 60 },
  { id: '4', name: 'General Repairs', price: 70 },
];
...
export default function BookingScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScreenHeader title="Book Handyman" showBack />
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="E.g., Leaky faucet in kitchen, need new outlet installed..."
