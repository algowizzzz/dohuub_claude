...
const MOCK_PROVIDER = {
  id: '1',
  name: 'DoHuub Home Repair',
  description: 'Professional handyman services for all your home repair needs. From plumbing to electrical work, our certified technicians handle it all.',
  rating: 4.8,
  reviewCount: 189,
  isPoweredByDoHuub: true,
  services: [
    { id: '1', name: 'Plumbing Repair', price: 80, duration: '1-2 hours' },
    { id: '2', name: 'Electrical Work', price: 100, duration: '1-2 hours' },
    { id: '3', name: 'Furniture Assembly', price: 60, duration: '1-2 hours' },
    { id: '4', name: 'General Repairs', price: 70, duration: '1-3 hours' },
  ],
...
export default function ProviderDetailScreen() {
  ...
  const handleBookNow = () => {
    router.push(`/services/handyman/${id}/book`);
  };
  ...
  const handleViewReviews = () => {
    router.push(`/services/handyman/${id}/reviews`);
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.heroImage}>
          <Ionicons name="hammer" size={64} color={colors.gray[400]} />
        </View>
