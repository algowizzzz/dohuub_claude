...
const MOCK_REVIEWS = [
  {
    ...
    rating: 5,
    date: 'Jan 10, 2026',
    comment: 'Beautiful property, exactly as described. Great location.',
  },
  {
    id: '2',
    authorName: 'Susan M.',
    rating: 5,
    date: 'Jan 6, 2026',
    comment: 'Very responsive landlord. Move-in was smooth.',
  },
  {
    id: '3',
    authorName: 'James W.',
    rating: 4,
    date: 'Jan 2, 2026',
    comment: 'Good property, minor maintenance issues were fixed quickly.',
  },
];

/**
 * Rental Property Reviews Screen
 */
export default function RentalsReviewsScreen() {
